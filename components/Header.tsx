  ...
  return (
    <header className="py-6 border-b bg-white/80 backdrop-blur">
      <div className="container-base flex items-center justify-between">
        ...
        {/* NAV */}
        <nav className="flex items-center gap-6 mr-7">
          <a href="/blog" className="text-md font-medium no-underline">Blog</a>
          <a href="/about" className="text-md font-medium no-underline">Tentang</a>
        </nav>
      </div>
    </header>
  );
